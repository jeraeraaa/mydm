...
@section('content')
    {{-- Dashboard --}}
    @php
        $user = auth()->guard('anggota')->user(); // Dapatkan user dari guard yang benar
    @endphp

    @if ($user->role && ($user->role->name === 'admin' || $user->role->name === 'super_user'))
        <div class="dashboard-content">
            <h3>Welcome to Dashboard, {{ $user->nama_anggota }}</h3>
            <div class="row">
            ...
            {{-- Overview kegiatan yang akan datang --}}
            <div class="col-lg-8 col-md-6 pt-4">
