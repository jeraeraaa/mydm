<nav class="absolute inset-x-0 top-0 z-50 bg-white shadow-md flex items-center justify-between p-6 lg:px-8"
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/alat"
            class="text-sm font-semibold leading-6 {{ Request::is('alat') ? 'bg-orange-500 text-white rounded-full px-4 py-2' : 'text-orange-500 hover:bg-orange-500 hover:text-white rounded-full px-4 py-2' }}">Alat</a>
        <a href="/absensi"
            class="text-sm font-semibold leading-6 {{ Request::is('absensi') ? 'bg-orange-500 text-white rounded-full px-4 py-2' : 'text-orange-500 hover:bg-orange-500 hover:text-white rounded-full px-4 py-2' }}">Absensi</a>
        <a href="/kontak"
            class="text-sm font-semibold leading-6 {{ Request::is('kontak') ? 'bg-orange-500 text-white rounded-full px-4 py-2' : 'text-orange-500 hover:bg-orange-500 hover:text-white rounded-full px-4 py-2' }}">Kontak</a>
        <a href="/profil"
    ...
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        @guest
            <a href="{{ route('login') }}"
                class="text-sm font-semibold leading-6 {{ Request::is('login') ? 'bg-orange-500 text-white rounded-full px-4 py-2' : 'text-orange-500 hover:bg-orange-500 hover:text-white rounded-full px-4 py-2' }}">
                Log in
                <span aria-hidden="true">&rarr;</span>
            </a>
            <a href="{{ route('register') }}"
                class="ml-4 text-sm font-semibold leading-6 {{ Request::is('register') ? 'bg-orange-500 text-white rounded-full px-4 py-2' : 'text-orange-500 hover:bg-orange-500 hover:text-white rounded-full px-4 py-2' }}">
                Register
                <span aria-hidden="true">&rarr;</span>
            </a>
        @else
